...
- **Progression System**: Optional prompts and completion workflows from `directions.json`
...
<head>
  ...
  <script src="/editors/directions/Directions.js"></script>
</head>
<body>
  ...
  <script type="module">
    ...
    import { MetaGame } from '/editors/directions/MetaGame.js';
...
```javascript
import { AbstractGame } from '/editors/directions/AbstractGame.js';
...
To enable prompts and submit workflows, add your editor to `directions.json`:
...
When a save exists and the editor is configured in directions.json:
...
| `prompt-display` | No | Displays progression prompts from directions.json |
...
- `editors/concrete-2-1-directions/` - Grid-based spatial text editor
