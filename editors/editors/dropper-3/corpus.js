const POS_ORDER_CLASSIC = ['verb', 'noun', 'adjective', 'random', 'linear', 'linear'];
const POS_ORDER = ['linear', 'linear', 'verb', 'verb', 'verb', 'noun', 'noun', 'noun', 'adjective', 'adjective', 'adjective', 'random', 'random', 'random'];
...
class Corpus {
    ...
    getNextWordPOS() {
        ...
        let POS = this.wordPOSOrder[this.posIndex++ % this.wordPOSOrder.length];
