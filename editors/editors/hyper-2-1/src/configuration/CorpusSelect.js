    ...
    const modal = createModal(`
      <div class="modal-content" style="max-width: 900px;">
        <div class="modal-header">
          ...
          <p class="option-description" style="margin-top: 0; font-size: 0.95em;">Choose from the text sources below to begin.</p>
        </div>
        <div class="modal-body" style="display: flex; flex-direction: row; gap: 20px; padding: 20px;">
          <!-- Wikipedia Section -->
          <div id="wiki-section" style="
            flex: 1; 
            padding: 20px; 
            border-radius: 8px;
            position: relative;
          ">
            <h4 style="margin: 0 0 15px 0; font-size: 1.3em;">Wikpedia Articles</h4>
            ${this.wikiSelect.getSectionHTML()}
          </div>
          
          <!-- Custom Text Section -->
          <div id="custom-text-section" style="
            flex: 1; 
            padding: 20px; 
            border-radius: 8px;
            position: relative;
          ">
            <h4 style="margin: 0 0 15px 0; font-size: 1.3em;">Other Texts</h4>
