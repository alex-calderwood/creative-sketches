import { TextStreamComponent } from './TextStreamComponent.js';
...
export class ClassicDomTextStreamComponent extends TextStreamComponent {
  ...
  blockFromToken(token, left=null, top=null, width=null, height=null) {
    left = left ?? this.tokenStart.left;
    top = top ?? this.tokenStart.top;
    width = width ?? this.game.cellWidth;
    height = height ?? this.game.cellHeight;
