export class SpellcheckPerformance {
    constructor(options = {}) {
    ...
    async initialize(options = {}) {
      ...
      this.onEdit = this.options.onEdit;
    ...
    getState() {
      let text = getTextWithWhitespace(this.targetElement);
      return {
        text,
        ...this.textState,
      }
...
//   // Create new instance
//   window.demoSpellChecker = new SpellcheckPerformance({
//     checkDelay: 500,
//     squiggleColor: 'red',
//     dict: dictType,
//     reverse: reverse
